  ...
  return (
    <div className="leading-normal tracking-normal text-white gradient">
        ...
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <h1 className="my-4 text-5xl font-bold leading-tight">
              Welcome to QCM Builder
            </h1>
            <p className="leading-normal text-2xl mb-8">
              Create, manage, and share your quizzes effortlessly with our
              intuitive platform. Perfect for educators, trainers, and quiz
              enthusiasts.
            </p>
          </div>
          <div className="w-full md:w-3/5 py-6 text-center">
            ...
            >
              ...
              <g>
                <path
                  id="uuid-bb35f39c-94aa-41c4-b5d9-34ca9a9e88f1-455"
                ...
                />
                <path
                  id="uuid-97233535-ec91-4408-928f-bf1e5273ca3e-456"
          ...
          <div className="flex flex-wrap">
            <div className="w-5/6 sm:w-1/2 p-6">
              ...
              <p className="text-gray-600 mb-8">
                Our platform allows teachers to create their own tests
                effortlessly. Customize your quizzes to fit your curriculum and
                assess your students effectively.
              </p>
            </div>
          ...
          <div className="flex flex-wrap flex-col-reverse sm:flex-row">
            ...
            <div className="w-full sm:w-1/2 p-6 mt-6">
              <div className="align-middle">
                <h3 className="text-3xl text-gray-800 font-bold leading-none mb-3">
                  Connect Teachers and Students Worldwide
                </h3>
                <p className="text-gray-600 mb-8">
                  We bridge the gap between teachers and students from different
                  parts of the world. Share your quizzes and collaborate with
            ...
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <div className="flex flex-wrap no-underline hover:no-underline">
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  QCM Builder has made creating quizzes so easy and efficient.
                  My students love the interactive tests!
                </p>
              </div>
            </div>
          </div>
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <div className="flex flex-wrap no-underline hover:no-underline">
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  The platform is user-friendly and has helped me connect with
                  students from all over the world. Highly recommend!
                </p>
              </div>
            </div>
          </div>
          <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
            <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
              <div className="flex flex-wrap no-underline hover:no-underline">
                ...
                <p className="text-gray-800 text-base px-6 mb-5">
                  QCM Builder has transformed the way I create and manage
                  quizzes. It's a fantastic tool for educators!
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto  text-center py-6">
        ...
        <br />
        <a
          href="mailto:mohammedsebaa2610@gmail.com"
          className="mx-auto mb-28 lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
        >
          Send Email
        </a>
        <br />
